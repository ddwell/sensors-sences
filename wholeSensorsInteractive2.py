...
def mainEvent(fps = 1.0, lcd_fps = 0.25, messageDuration = 3.0, readCooldown = 0.01, lcdMessages=True, interactive = True, exitOnReadError=False):       
            ...
            while True:                  
                if frametime >= spf:
                    ...
                    try:
                        ...
                        sound = 2* 120 * grovepi.analogRead(Devices['sound_sensor']) / 1024
    ...
    #                     grovepi.analogWrite(Devices['led_green'],int(sound/4))
                    ...
                    #print('%s, %dcm, %dlum,%ddB' % (t,distance,light,sound) , end='\r')  
                    print('%s, %dcm, %dlum,%ddB, %3.1f%%, %3.1fC, %3.3f   ' % (t,distance,light,sound,hum,temp,gas))
