...
#                 sound = 0
                light = 0#grovepi.analogRead(Devices['photoresistor'])
                distance = 0#grovepi.ultrasonicRead(Devices['ultrasonic_ranger'])
                [temp, hum] = [0,0]#grovepi.dht(Devices['dht_sensor'], 0)        
